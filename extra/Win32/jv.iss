...
OutputDir=..\..\
OutputBaseFilename=JournalViewer-1.8.4
Compression=lzma
...
[Files]
Source: "..\..\build\bin\JournalViewer.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "JournalViewer.ico"; DestDir: "{app}"; Flags: ignoreversion

; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\JournalViewer.ico"; IconIndex: 0
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\JournalViewer.ico"; IconIndex: 0; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\JournalViewer.ico"; IconIndex: 0; Tasks: quicklaunchicon
