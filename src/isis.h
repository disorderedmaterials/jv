...
class ISIS
{
	...
	enum ISISInstrument { LOCAL, ALF, ARGUS, CHIPIR, CHRONUS, CSP, EMMA, EMU, ENG, GEM, HET, HIFI, HRP, IMAT, INS, INTER, IRS, IRS_SET, LARMOR, LET, LOQ, MAP, MAR, MER, MUS, NIMROD, OFFSPEC, OSI, PRL, POL, POLREF, SLS, SANS2D, SRF, SXD, TSC, VESUVIO, WISH, ZOOM, nInstruments };
	// Instrument Location
