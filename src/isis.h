...
class ISIS
{
	...
	enum ISISInstrument { LOCAL, ALF, ARGUS, CHIPIR, CSP, EMMA, EMU, ENG, GEM, HET, HIFI, HRP, IMAT, INS, INTER, IRS, LARMOR, LET, LOQ, MAP, MAR, MER, MUS, NIMROD, OFFSPEC, OSI, PRL, POL, POLREF, SLS, SANS2D, SRF, SXD, TSC, VESUVIO, WISH, ZOOM, nInstruments };
	// Instrument Location
